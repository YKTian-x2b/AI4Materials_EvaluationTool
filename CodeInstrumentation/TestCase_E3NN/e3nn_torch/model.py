...
class GraphConvolution(torch.nn.Module):
    def __init__(self,
        ...
        self.edge2weight = FullyConnectedNet(
            [number_of_basis] + radial_layers * [radial_neurons] + [self.tensor_edge.weight_numel],
    ...
    def forward(self,
                ...
                numb, n):
        # atomic_number A -> onehot Embedding
...
class GraphNetworkVVN(torch.nn.Module):
    def __init__(self,
        ...
        self.emx = torch.nn.Linear(input_dim, input_embed_dim, dtype=torch.float32)
        self.emz = torch.nn.Linear(node_dim, node_embed_dim, dtype=torch.float32)
