...
def main():
    ...
    scheduler = optim.lr.MultiStepDecay(args.lr, args.lr_milestones, gamma=0.1)
    for epoch in range(args.start_epoch, args.epochs):
        train(train_loader, model, criterion, optimizer, epoch, normalizer, gpu_device)
        mae_error = validate(val_loader, model, criterion, normalizer, gpu_device)
