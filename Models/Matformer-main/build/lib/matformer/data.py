...
def get_train_val_loaders(
    ...
    if mp_id_list is not None:
        if mp_id_list == 'bulk':
            ...
            with open('./dataConfig/bulk_megnet_train.pkl', 'rb') as f:
                dataset_train = pk.load(f)
            with open('./dataConfig/bulk_megnet_val.pkl', 'rb') as f:
                dataset_val = pk.load(f)
            with open('./dataConfig/bulk_megnet_test.pkl', 'rb') as f:
                dataset_test = pk.load(f)
        
        if mp_id_list == 'shear':
            print('using mp shear dataset')
            with open('./dataConfig/shear_megnet_train.pkl', 'rb') as f:
                dataset_train = pk.load(f)
            with open('./dataConfig/shear_megnet_val.pkl', 'rb') as f:
                dataset_val = pk.load(f)
            with open('./dataConfig/shear_megnet_test.pkl', 'rb') as f:
                dataset_test = pk.load(f)
